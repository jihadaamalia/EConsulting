		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right main-nav">
					...
					<li><a href="riwayatdokter.php" >Konsultasi</a></li>
		...
		<div class="row ">
			...
			<form action="" method="post">
				<table class="table">
			        ...
			        <?php
					$pesan_masuk = mysql_query("SELECT * FROM pesan_pasien WHERE nama_dok='".$_SESSION['nama']."'"); //mengambil data dari database
		...
		<div>
			...
			<form action="" method="post">
				<table class="table">
			        ...
			        <?php
					$pesan_keluar = mysql_query("SELECT * FROM pesan_dokter WHERE nama_dok='".$_SESSION['nama']."'"); //mengambil data dari  database
